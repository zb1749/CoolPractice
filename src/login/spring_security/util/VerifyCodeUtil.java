package login.spring_security.util;
...
public class VerifyCodeUtil {
    ...
    public static BufferedImage getVerifyCodeImage(String code) {
     ...
     */
    public static ByteArrayInputStream getVerifyCodeInputStream(String securityCode) {

        BufferedImage image = getVerifyCodeImage(securityCode);
