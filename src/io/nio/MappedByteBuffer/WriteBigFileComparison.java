package io.nio.MappedByteBuffer;
...
public class WriteBigFileComparison {
    ...
    public static void writeWithFileChannel() throws IOException {
        File file = new File("D:\\incoming\\201701\\writeWithFileChannel.dat");
        if (file.exists()) {
            file.delete();
        }
    ...
    public static void writeWithMappedByteBuffer() throws IOException {
        File file = new File("D:\\incoming\\201701\\writeWithMappedByteBuffer.dat");
        if (file.exists()) {
            file.delete();
        }
    ...
    public static void writeWithTransferTo() throws IOException {
        File file = new File("D:\\incoming\\201701\\writeWithTransferTo.dat");
        if (file.exists()) {
            file.delete();
        }
    ...
    public static void main(String[] args) throws IOException {
        System.out.println("before channel : " + DateUtil.getCurrentMilliSecond());
        writeWithFileChannel();
        System.out.println("before transfer : " + DateUtil.getCurrentMilliSecond());
        writeWithTransferTo();
        System.out.println("before mapped buffer : " + DateUtil.getCurrentMilliSecond());
        writeWithMappedByteBuffer();
        System.out.println("after all : " + DateUtil.getCurrentMilliSecond());
    }
